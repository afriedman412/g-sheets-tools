    ...
    try:
        ...
        if not os.path.exists(creds_path):
            ...
            if [
                ...
                if "apps.googleusercontent.com" in f
            ]:
                try:
                    cred_file = [
                        f
                    ...
                    copyfile(os.path.expanduser("~/") + cred_file, creds_path)
        ...
        if not creds or not creds.valid:
            ...
            if creds and creds.expired and creds.refresh_token:
                ...
                flow = InstalledAppFlow.from_client_secrets_file(
                    creds_path, DEFAULT_SCOPES
                )  # replaced 'credentials.json'
    ...
    "requests": [
        ...
        },
        {
            "repeatCell": {
                ...
                "cell": {
                    "userEnteredFormat": {"textFormat": {"fontSize": 10, "bold": True}}
                },
